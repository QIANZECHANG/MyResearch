...
\begin{table}[h]
  ...
  \hline
    FQ3     & Age &  \begin{tabular}{l}Answer 1 to 6 as age under 15, age 16-19, age 20-29, age\\30-39, age 40-49, age 50-59, age 60-69, age over 70. \end{tabular} \\
  \hline
...
\begin{table}[h]
  ...
  \hline
   \textbf{Q8} & \begin{tabular}{l}\textbf{Number of earthquake experience (Answer 1 to 4 as}\\\textbf{one time,2 to 3 times, 4 to 6 times, over 7 times.)}\end{tabular} \\
   \hline
  \end{tabular}
\end{table}
