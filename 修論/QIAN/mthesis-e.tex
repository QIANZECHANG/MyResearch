...
\begin{table}[h]
  ...
  \begin{tabular}{ccc|ccc|ccc|cccc}
   ...
   Syn & LoC & ML& T & FP/FN & sec & $\checkmark$ & $\times$ & sec & Fuzzer & $\checkmark$ & $\times$ & SA/Fuzz/Total  \\
    ...
    test7     & 9    & 2  & 1  & 0/1     & 0.14  & 0  & 1  & 0.05      & 2   & 2    & 0  & 0.01/7.43/8.61 \\
    test8     & 26    & 4  & 0  & 0/4     & 0.49  & -  & -  &  -      &  \begin{tabular}{c}3-4\\4\end{tabular}  & \begin{tabular}{c}0-3\\4 \end{tabular}   & \begin{tabular}{c}0-1\\0\end{tabular}  & \begin{tabular}{c}0.05/4.17/7.17\\0.05/9.94/13.17\end{tabular} \\
    test9     & 24    & 3  & 1  & 0/2     & 0.42  & 1  & 0  & 0.05      & 3   & 3    & 0  & 0.04/8.91/11.29 \\
    test10     & 15    & 2  & 2  & 0/0     & 0.42  & 1  & 1  &  0.07      &  2  & 2  & 0 & 0.02/7.67/9.04 \\
    \hline
  \end{tabular}
\end{table}

\begin{table}[h]
  \caption[Characteristics of synthesize code]{Characteristics of synthesize code }
  \label{syncode}
  \centering
  \begin{tabular}{cc}
   Syn &  Feature \\
